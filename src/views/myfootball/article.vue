        ...
        <v-row align="start" justify="center">
            ...
            <v-col cols="12" md="7" lg="6" xl="5">
                ...
                <p>En partenariat avec Nike depuis 2010, l'équipe de France a décidé de prolonger son contrat avec le géant américain jusqu'en 2026. Getty Images
                    ...
                    Sponsor historique pendant plus de 40 ans, Adidas avait perdu l'équipe de France en 2010 au profit de Nike. L'équipementier allemand pensait pouvoir récupérer les bleus suite à l'appel d'offre lancé par la Fédération française de football le 2 novembre 2016.  
                    Alors que New Balance et Under Armour étaient également sur les rangs pour récupérer les finalistes de l'Euro 2016, c'est finalement Nike qui a de nouveau été choisi par la FFF.  
                </p>
            </v-col>
        </v-row>
        <br>
        <v-row class="mt-6" align="start" justify="center">
            <v-col cols="12" md="7" lg="6" xl="5">
                 <h1>Bayern Munich : le très courtisé Jamal Musiala a fait son choix</h1>
                    ...
                    <br>
                 <p>Le passé est en effet de rigueur puisque, ce mercredi, l'intéressé, qui aurait également pu opter pour le Nigeria, pays d'origine de son père, a annoncé avoir fait son choix. «J'ai beaucoup réfléchi à cette question. Qu'est-ce qui est le mieux pour mon avenir ? Où aurais-je le plus de chances de jouer ? Finalement, j'ai simplement écouté le sentiment que j'avais depuis longtemps déjà qui me disait que la bonne décision était de jouer pour l'Allemagne, le pays où je suis né. Même si cela n'a pas été une décision facile pour moi», a-t-il confié à The Athletic.
                     <br>
        ...
        <v-row class="mt-6" align="start" justify="center">
         ...
         <v-row class="mt-6" align="start" justify="center">
            ...
            <v-col cols="12" md="7" lg="6" xl="5">
                ...
                <br>
                <p>Le club de la capitale devra notamment se passer des services de Sergio Ramos, Marcelo, Dani Carvajal, Eden Hazard et Karim Benzema, l’attaquant français ne pouvant pas tenir sa place en raison d’une blessure à la cheville gauche. La Maison Blanche de Zinedine Zidane rencontre une Dea qui occupe la cinquième place de la Serie A et disposera de toutes ses forces vives. Le Real Madrid devrait aligner Lucas Vazquez sur le flanc droit de la défense, tandis que Nacho accompagnerait Raphaël Varane dans l’axe. Si le milieu s’annonce sans surprise, le secteur offensif doit être recomposé et Mariano Diaz pourrait de nouveau bénéficier de la confiance de « Zizou » comme numéro 9 pour pallier à l’indisponibilité de Karim Benzema. En face, l’écurie lombarde pourrait associer Luis Muriel et Duvan Zapata sur le front de l’attaque. Le onze probable de l’Atalanta : Gollini – Toloi, Romero, Djimsiti – Maehle, De Roon, Freuler, Gosens – Zapata, Pessina, Muriel. Le onze probable du Real Madrid : Courtois – Vazquez, Varane, Nacho, Mendy – Modric, Casemiro, Kroos – Asensio, Mariano, Vinicius.</p>
            </v-col>
        </v-row>
